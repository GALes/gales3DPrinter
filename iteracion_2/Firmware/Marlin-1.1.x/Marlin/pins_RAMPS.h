...
//////////////////////////
  ...
  //
    ...
    #define LCD_PINS_D7         64
      ...
      #define LCD_PINS_RS       -1 //27
      #define LCD_PINS_ENABLE   29
      #define LCD_PINS_D4       -1 //25
      ...
      #define LCD_PINS_D7       65
        ...
        #define LCD_PINS_DC     -1 //25   // Set as output on init
        #define LCD_PINS_RS     -1 //27   // Pull low for 1s to init
        // DOGM SPI LCD Support
        #define DOGLCD_CS       16
        #define DOGLCD_MOSI     17
        #define DOGLCD_SCK      -1 //23
